...
Professor/Mentor: Prof. Eric Ford 

{\sl Data Scientist} \hfill 2017 \\ 
Location: Geotab, Oakville, ON, Canada \\
Manager: Mike Branch \\
Work: Detect potholes via machine learning using Geotab's vehicle accelerometer data. 
...
%	TEACHING
%----------------------------------------------------------------------------------------
\section{\centerline{MENTORING}} 

\vspace{8pt} % Gap between title and text

I am currently supervising and mentoring the following student through a research project:

Christian Gilbertson, graduate student at Penn State University. \hfill 2017--present \\
{\sl Research: Machine Learning to predict orbital stability of high-N multi-planet systems.} \\

\section{\centerline{TEACHING}} 

\vspace{8pt} % Gap between title and text

I held the position of ``Teaching Assistant" for all entries listed below, and was responsible for creating assignments, leading tutorial lectures, performing planetarium shows, conducting nighttime telescope observing sessions, marking and/or proctoring:

``{\sl PHYB54: Mechanics: From Oscillations to Chaos "}, University of Toronto. \hfill 2017 \\ \\
